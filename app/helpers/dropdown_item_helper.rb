module DropdownItemHelper
    def dropdown_item(icon_name, text, path = "#", method: :get, data_testid: nil)
        ...
        content_tag(:div, role: "none", class: "pl-3 focus:text-primary-600 flex items-center", data: { testid: data_testid }) do
